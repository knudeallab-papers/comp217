...
public class ButtonForm5 extends JButton
{
    public ButtonForm5(String imgPath)
    {
        super();
        ...
        Img = Img.getScaledInstance(420, 120, Image.SCALE_SMOOTH);
        Image ImgDark = imgIconDark.getImage();
        ImgDark = ImgDark.getScaledInstance(420, 120, Image.SCALE_SMOOTH);
