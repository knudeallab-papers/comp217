...
public class B_infoPage extends JPanel{
    ...
    public B_infoPage(String errorMSG, String name, String ID, String phone)
    {
        super();
        setBackground(BorrowMain.BGCOLOR);
        setLayout(new GridLayout(8, 1));

        centerBoldLabel title = new centerBoldLabel("이용자 정보 입력", 42);
