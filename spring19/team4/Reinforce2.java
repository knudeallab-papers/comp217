...
public class Reinforce2 extends JFrame implements ActionListener{
	...
	class StarForce extends JFrame{
		...
		public StarForce() {
			...
			JLabel title=new JLabel("별을 정확한 곳에 멈추세요.성공 시 확률 +5%");
	...
	public int get_pay() {
		...
		switch(level) {
		case 1:pay=a.get(0);break;
		case 2:pay=a.get(1);break;
		case 3:pay=a.get(2);break;
		case 4:pay=a.get(3);break;
		case 5:pay=a.get(4);break;
		case 6:pay=a.get(5);break;
		default:
			pay=-1;
		}
		return pay;
	...
	public static String get_image(int level) {
		String image="s1.jpg";
		switch(level) {
		case 1:image="s1.jpg";break;
		case 2:image="s2.jpg";break;
		case 3:image="s3.jpg";break;
		case 4:image="s4.jpg";break;
		case 5:image="s5.jpg";break;
		case 6:image="s6.png";break;
	...
	public String get_name() {
		String image="목 검";
		switch(level) {
		case 1:image="목 검";break;
		case 2:image="철 검";break;
		case 3:image="예리한 검";break;
		case 4:image="강철 검";break;
		case 5:image="엄청 좋은 검";break;
		case 6:image="광선검";break;
