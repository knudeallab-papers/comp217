...
public class InputForm extends JFrame {
	 JLabel la_number,la_name,la_pay,la_pos,la_phone;
	 JTextField tf_number,tf_name, tf_pay, tf_pos,tf_phone;
	 ...
	 public InputForm() {
		setTitle("입력폼");
		  ...
		  la_name = new JLabel("등급 ");
		  la_pay = new JLabel("이름 ");
		  la_pos= new JLabel("마일리지");
		  ...
		  la_phone.setBounds(30, 230, 30, 30);
		  ...
		  tf_phone.setBounds(80, 230, 80, 30);
